...
\subsubsection{Bootstrapping noisy measurements}
...
Another approach, coined \textbf{Recorrupted2Recorrupted} aims to provide a way to simulate noisy image pairs satisfying statistical conditions from single measurements.
...
\cite{gr2r} go beyond the additive gaussian noise model and propose a generic formulation for any posterior distribution $p(Y|X)$ that belongs to the exponential family of distributions.
In particular, we are interested in the case of Poisson noise which is very common in nuclear imaging.
